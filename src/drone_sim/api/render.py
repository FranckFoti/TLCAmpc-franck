...
def render_png(
    *,
    ...
    drone_radii: list[float],
    drone_safety_zones: list[float],
    drone_colors: list[object],
    safety_colors: list[object],
    trace_colors: list[object],
    drone_traces: list[list[np.ndarray]],
