...
def render_from_snapshot(snapshot: dict, figsize: tuple[float, float] = (10, 8),
                         dpi: int = 150, show_title: bool = True) -> Figure:
    ...
    for d in snapshot["drones"]:
        ...
        # Ghost max sphere for adaptive drones
...
def main() -> None:
    ...
    fig = render_from_snapshot(snapshot, figsize=tuple(args.figsize), dpi=args.dpi, show_title=not args.no_title)
